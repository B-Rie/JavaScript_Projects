...
This time, they want to convert dog ages to human ages and calculate the average 
...
// Data Transformation Methods: map, filter, and reduce
...
const calcAverageHumanAge = function(ages) {
	...
	const average = adultDogs.reduce((acc, curr) => (acc+curr), 0)/adultDogs.length;
	console.log(average);
}
