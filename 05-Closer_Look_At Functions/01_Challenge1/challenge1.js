...
// We use the .bind() to continuously use the registerNewAnswer function
document.querySelector('.poll').addEventListener('click', poll.registerNewAnswer.bind(poll));

// They call() will let us use the property answers in the poll object
// when using call({}): the {} specifies which property to change
