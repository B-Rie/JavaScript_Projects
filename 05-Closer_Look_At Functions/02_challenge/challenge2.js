...
selected h1 element ('header') to blue, each time the BODY element is clicked. 
...
// As the function enviroment is executed and gone, the function within the addEventListener
// is still active.